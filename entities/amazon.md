...
Amazon recurs as the podcast's exhibit for deliberate, hard-edged big-tech culture: up-or-out performance management, frugality, and an operating discipline other companies copy. Nine episodes touch it, anchored by two long Ethan Evans (VP) interviews and insider accounts from principal-engineer and manager levels.

## What the episodes reveal

- **Intensity is the norm.** Stefan Mai's first week in 2012: his manager gathered the team at 6pm and committed them to a nights-and-weekends "death march" for 6–8 months; he calls 50–60 hour weeks "fairly common" for the ambitious ([Stefan Mai](../sources/meta-senior-manager-m2-on-manager.md)). Dwayne Reeves's new-grad data point: Amazon's line was "we don't negotiate with new grads," versus Facebook's unsolicited offer increase ([Hack tech lead](../sources/tech-lead-for-metas-most-used-programming.md)).
- **Performance machinery: URA, PIPs, stack ranking.** Amazon's unregretted-attrition goal (~4–7% a year) exists because when it was removed, managers simply stopped having hard conversations — but it makes PIPs largely self-fulfilling: every PIP'd person Evans has coached was fired anyway, so "spend that time on the PIP looking for your next job" ([Ethan Evans](../sources/amazon-vp-on-promotions-getting-fired.md)). Mai, who administered the system, agrees the bottom bucket (~7–15%) is real and universal at scale but notes Amazon HR was "pretty savage" box-checking where [Meta](meta.md) HR exhausted avenues first; both companies run public ratings plus a private "top tier" process, though frugal Amazon claws back the pay Meta lavishes on its upper quintile ([Stefan Mai](../sources/meta-senior-manager-m2-on-manager.md)). Steve Huynh adds the IC view: an explicit up-or-out policy for SDE1s that relaxes at higher levels, and layoffs that in his observation hit people lacking cultural fit rather than poor performers ([Steve Huynh](../sources/amazon-principal-engineer-on-layoffs.md)). Bryan Cantrill supplies the outside verdict: stack ranking is "organizational cancer" that incentivizes keeping dead weight as wood-chipper fodder and "teaches you that your team are adversaries" ([Bryan Cantrill](../sources/distinguished-eng-on-stack-ranking.md)); Brian Attwell claims Amazon underpays top performers "because they can get away with it" ([CloudKitchens CTO](../sources/cloudkitchens-cto-on-intelligence.md)).
...
- [calibrations-and-ratings](../concepts/calibrations-and-ratings.md), [layoffs](../concepts/layoffs.md) — URA, PIPs, stack ranking
- [corporate-politics](../concepts/corporate-politics.md) — empire building, promo slates
- [big-tech-culture](../concepts/big-tech-culture.md) — death marches and frugality
- [AWS](aws.md) — the cloud arm with its own page
