...
- [Anders Hejlsberg](anders-hejlsberg.md) — agrees AI entrenches incumbent languages and that verification is the human's remaining job, but concludes the lever is *tooling speed* (the machine is the reader) rather than language simplicity, and is the static-typing counterparty to Lua ([his episode](../sources/creator-of-typescript-10x-faster.md))
