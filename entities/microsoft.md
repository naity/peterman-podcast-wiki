...
Microsoft appears in nine episodes in two guises: as a career home for very senior ICs (David Fowler's 11 promotions to Distinguished Engineer, Brendan Burns as Technical Fellow) and as the historical antagonist of the browser wars.

## What the episodes reveal

- **The ladder.** Microsoft levels run 59–70+ with two levels per title band (senior at 63/64, three principal levels, three partner bands, then Technical Fellow); you can't tell from a title which notch someone occupies ([David Fowler](../sources/intern-to-microsoft-distinguished.md)). Distinguished Engineer (level 70) is not a normal promo: technical fellows peer-review a decade-long body of work — Fowler's package leaned on ~7 years of deferred impact from .NET Core, and "at those levels, everyone's a unicorn" (Guido van Rossum is at his level; Anders Hejlsberg and Dave Cutler sit above) ([same](../sources/intern-to-microsoft-distinguished.md)).
- **Bottom-up career mechanics.** Fowler's engine was "code is currency" — troll forums for customer problems, build the fix first, then show PMs/architects; SignalR started as a nights-and-weekends project that Microsoft made official, and NuGet was born in a meeting with Scott Guthrie. His summary of big-company agency: "you can just do things," and success compounds into permission to fail ([David Fowler](../sources/intern-to-microsoft-distinguished.md)).
...
- [David Fowler](david-fowler.md) — intern to Distinguished Engineer (level 70); NuGet, SignalR, .NET Core
- [Brendan Burns](brendan-burns.md) — Technical Fellow/CVP, Azure
...
- [big-tech-culture](../concepts/big-tech-culture.md) — the Satya-era culture turnaround
- [career-growth](../concepts/career-growth.md), [promotions](../concepts/promotions.md) — the 59–70 ladder
- [open-source](../concepts/open-source.md) — .NET Core, Kubernetes-at-Azure
- [Mozilla](mozilla.md), [Google](google.md) — browser-war counterparties
