...
- [Creator of OCaml: Functional Programming, Formal Verification, Programming Languages | Xavier Leroy](creator-of-ocaml-functional-programming.md) — machine-checkable proofs applied to software ([formal-verification](../concepts/formal-verification.md)); Leroy leans on the computability/undecidability foundations Wigderson maps.
- [Turing Award Winner: Early AI, LLM Predictions, Causality | Judea Pearl](turing-award-winner-early-ai-llm.md) — the same genre of argument in a different field: Pearl's ladder of causation is an impossibility result about what data can tell you.
