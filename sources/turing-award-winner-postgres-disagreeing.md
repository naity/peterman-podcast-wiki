...
- [Turing Award Winner: Early AI, LLM Predictions, Causality | Judea Pearl](turing-award-winner-early-ai-llm.md) — Pearl supplies the mechanism behind Stonebraker's text-to-SQL collapse: models summarize interpretation humans already published, so they fail where nobody wrote your schema's meaning down.
