...
- [Creator of TypeScript: 10x Faster Typescript, Why AI Won't Replace SWEs | Anders Hejlsberg](creator-of-typescript-10x-faster.md) — the corpus's closest parallel episode: another mainstream-language creator who stayed hands-on in the compiler, another quality-not-capability skeptic of AI-written code, and the second guest to arrive independently at "if AI eliminates juniors, where do the seniors come from?"
