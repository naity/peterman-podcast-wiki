...
- [Turing Award Winner: Early AI, LLM Predictions, Causality | Judea Pearl](turing-award-winner-early-ai-llm.md) — another proof of optimality (Pearl on alpha-beta pruning, which surprised Knuth) and a shared insistence that 'optimal' is a claim needing a theorem.
