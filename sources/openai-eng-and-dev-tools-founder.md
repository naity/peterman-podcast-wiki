...
- [Creator of OCaml: Functional Programming, Formal Verification, Programming Languages | Xavier Leroy](creator-of-ocaml-functional-programming.md) — the maintainer's-side echo of Marsh's AI-slop problem (mostly-noise AI bug reports on OCaml/CompCert) and a GC-vs-ownership caveat to Rust enthusiasm.
- [Creator of Lua: Scripting, Programming Languages, Predictions | Roberto Ierusalimschy](creator-of-lua-scripting-programming.md) — language runtimes as embeddable infrastructure, and a contrasting read on how much AI changes the tooling layer.
