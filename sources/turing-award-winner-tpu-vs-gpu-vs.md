...
- [Turing Award Winner: Early AI, LLM Predictions, Causality | Judea Pearl](turing-award-winner-early-ai-llm.md) — the other half of the AI story: Patterson supplies the compute curve that made scaling work, Pearl argues compute was never the missing ingredient.
- [Creator of Lua: Scripting, Programming Languages, Predictions | Roberto Ierusalimschy](creator-of-lua-scripting-programming.md) — the pedagogical flip side of architectural complexity: learn a *historical* assembly (Intel 8080), because modern ISAs are too complex to learn from.
