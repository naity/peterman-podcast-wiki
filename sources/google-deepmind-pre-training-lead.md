...
- [Turing Award Winner: Early AI, LLM Predictions, Causality | Judea Pearl](turing-award-winner-early-ai-llm.md) — the direct counterargument to scaling: Pearl holds that rung-1 competence does not become causal competence with more data or compute.
