...
- [Creator of TypeScript: 10x Faster Typescript, Why AI Won't Replace SWEs | Anders Hejlsberg](creator-of-typescript-10x-faster.md) — TypeScript is the largest industrial instance of the static-types bet, with the twist that its types are purely a tooling artifact and have no runtime effect at all; "copilots need pilots" is Hejlsberg's IDE argument compressed into five words.
